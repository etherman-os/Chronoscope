      ...
      <section className="relative overflow-hidden">
        ...
        <div className="relative max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-24 sm:py-32 text-center">
          ...
          <p className="text-lg sm:text-xl text-slate-400 max-w-2xl mx-auto mb-10">
            See every click. Fix every bug. Finally understand how users interact with your native applications.
          </p>
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <button
              onClick={scrollToWaitlist}
              className="px-8 py-3 rounded-lg bg-brand-600 hover:bg-brand-700 text-white font-semibold transition-colors w-full sm:w-auto"
            >
              Join Waitlist
            </button>
            <a
              ...
              className="px-8 py-3 rounded-lg bg-slate-800 hover:bg-slate-700 border border-slate-700 text-white font-semibold transition-colors w-full sm:w-auto"
            >
              View on GitHub
            </a>
          </div>
      ...
      <section id="features" className="py-20 sm:py-24">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl sm:text-4xl font-bold mb-4">Built for modern teams</h2>
            <p className="text-slate-400 text-lg max-w-xl mx-auto">
              Everything you need to understand your users, without compromising on privacy or control.
            </p>
          </div>
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-5xl mx-auto">
            <PricingCard
              ...
              features={["Self-hosted deployment", "Community support", "Core replay features", "MIT license"]}
            ...
            <PricingCard
              ...
              features={["Cloud hosting included", "Priority email support", "Advanced analytics", "SSO & team management"]}
              highlighted
            ...
            <PricingCard
              ...
              features={["Custom SLA", "Dedicated support engineer", "On-premise deployment", "Custom integrations"]}
